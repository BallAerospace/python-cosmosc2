...
from cosmosc2.json_drb_object import JsonDRbObject
...
class TestDrbObject(unittest.TestCase):
    ...
    @patch("cosmosc2.json_drb_object.HTTPConnection.connect")
    ...
    @patch("cosmosc2.json_drb_object.HTTPConnection")
    ...
    @patch("cosmosc2.json_drb_object.time.sleep")
    @patch("cosmosc2.json_drb_object.HTTPConnection")
