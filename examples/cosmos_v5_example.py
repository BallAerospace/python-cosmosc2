...
# Updated from v0 to v1 for the cosmosc2 libaray. In v1 the libary can log
...
# Updated from v0 to v1 for the cosmosc2 libaray. In v1 you CAN set the hostname
# for all Cosmos v4 scripts. In v0 of cosmosc2 it would default to 127.0.0.1.
...
# Updated from v0 to v1 for the cosmosc2 libaray. In v1 you MUST set the port
# for all cosmos v4 scripts. In v0 of cosmosc2 the port was hard coded and
