...
def get_interface_names():
    return conneciton.write("get_interface_names")
...
def get_router_names():
    return conneciton.write("get_router_names")
...
def disconnect_router(router_name):
    return conneciton.write("disconnect_router", router_name)


def router_state(router_name):
    return conneciton.write("router_state", router_name)


def get_target_info(target_name):
    return conneciton.write("get_target_info", target_name)


def get_all_target_info():
    return conneciton.write("get_all_target_info")
...
def get_all_router_info():
    return conneciton.write("get_all_router_info")


def get_all_interface_info():
    return conneciton.write("get_all_interface_info")


def get_router_info(router_name):
    return conneciton.write("get_router_info", router_name)


def get_all_cmd_info():
    return conneciton.write("get_all_cmd_info")


def get_all_tlm_info():
    return conneciton.write("get_all_tlm_info")
...
def get_packet_loggers():
    return conneciton.write("get_packet_loggers")
...
def get_all_packet_logger_info():
    return conneciton.write("get_all_packet_logger_info")


def get_background_tasks():
    return conneciton.write("get_background_tasks")
...
def get_server_status():
    return conneciton.write("get_server_status")
...
def start_new_server_message_log():
    return conneciton.write("start_new_server_message_log")
...
def cmd_tlm_reload():
    return conneciton.write("cmd_tlm_reload")


def cmd_tlm_clear_counters():
    return conneciton.write("cmd_tlm_clear_counters")
