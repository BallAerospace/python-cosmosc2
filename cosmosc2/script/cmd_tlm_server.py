...
def get_interface_names():
    return cosmosc2.script.script.cmd_tlm_server.write("get_interface_names")
...
def get_router_names():
    return cosmosc2.script.script.cmd_tlm_server.write("get_router_names")
...
def disconnect_router(router_name):
    return cosmosc2.script.script.cmd_tlm_server.write("disconnect_router", router_name)


def router_state(router_name):
    return cosmosc2.script.script.cmd_tlm_server.write("router_state", router_name)


def get_target_info(target_name):
    return cosmosc2.script.script.cmd_tlm_server.write("get_target_info", target_name)


def get_all_target_info():
    return cosmosc2.script.script.cmd_tlm_server.write("get_all_target_info")
...
def get_all_router_info():
    return cosmosc2.script.script.cmd_tlm_server.write("get_all_router_info")


def get_all_interface_info():
    return cosmosc2.script.script.cmd_tlm_server.write("get_all_interface_info")


def get_router_info(router_name):
    return cosmosc2.script.script.cmd_tlm_server.write("get_router_info", router_name)


def get_all_cmd_info():
    return cosmosc2.script.script.cmd_tlm_server.write("get_all_cmd_info")


def get_all_tlm_info():
    return cosmosc2.script.script.cmd_tlm_server.write("get_all_tlm_info")
...
def get_packet_loggers():
    return cosmosc2.script.script.cmd_tlm_server.write("get_packet_loggers")
...
def get_all_packet_logger_info():
    return cosmosc2.script.script.cmd_tlm_server.write("get_all_packet_logger_info")


def get_background_tasks():
    return cosmosc2.script.script.cmd_tlm_server.write("get_background_tasks")
...
def get_server_status():
    return cosmosc2.script.script.cmd_tlm_server.write("get_server_status")
...
def start_new_server_message_log():
    return cosmosc2.script.script.cmd_tlm_server.write("start_new_server_message_log")
...
def cmd_tlm_reload():
    return cosmosc2.script.script.cmd_tlm_server.write("cmd_tlm_reload")


def cmd_tlm_clear_counters():
    return cosmosc2.script.script.cmd_tlm_server.write("cmd_tlm_clear_counters")
