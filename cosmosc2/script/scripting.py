...
def save_file_dialog(directory=cosmosc2.top_level.USERPATH, message="Save File"):
    _file_dialog(message, directory)


def open_file_dialog(directory=cosmosc2.top_level.USERPATH, message="Open File"):
    _file_dialog(message, directory)


def open_files_dialog(directory=cosmosc2.top_level.USERPATH, message="Open File(s)"):
    _file_dialog(message, directory)


def open_directory_dialog(
    directory=cosmosc2.top_level.USERPATH, message="Open Directory"
):
